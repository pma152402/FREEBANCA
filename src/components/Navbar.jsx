...
export default function Navbar() {
    ...
    return (
        <>
            <div ref={navRef} className={`bg-gradient-to-t from-cyan-700 to-cyan-900 fixed top-0 left-0 w-full z-200 text-gray-100 px-5 py-1 flex justify-between items-center transition-transform duration-500 border-b-2 border-cyan-200/40 shadow-lg shadow-cyan-500/60
                ${visibleNav ? "translate-y-0" : "-translate-y-full"}`}>

                <div className="flex flex-col items-center">
                    <h6 className="sm:text-xl md:text-2xl font-semibold border-b-2 border-gray-200">
                        FREEBANCA
                    </h6>
                </div>


                <ul className="flex gap-4 items-center md:text-lg sm:text-sm">
